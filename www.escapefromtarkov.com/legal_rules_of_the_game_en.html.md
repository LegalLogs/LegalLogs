...
1.8. Platform – the Game operator, namely: Battlestate Games Limited or other platforms, web-applications and social networks that are Game operators with the consent of Battlestate Games Limited.

2.  RULES FOR USING THE GAME
...
3.  LIABILITY OF THE USER FOR BREAKING THE RULES OF THE GAME
...
4.1. Periodically, Battlestate Games Limited has the right to amend and supplement these Rules of the Game for the purpose, for example, of including information about new products or services, increasing our users’ security or in connection with amendments to the legislation. Battlestate Games Limited notifies Users of introduction of such changes into these Rules of the Game to the email address specified by the User when registering the Account; you accept such changes unless you notify Battlestate Games Limited that you disagree with them within 10 (ten) calendar days of receiving the email notice from Battlestate Games Limited. In the email notice, Battlestate Games Limited advises you of your right not to agree the amendments, of the applied deadline for sending notifications and the legal consequences if you fail to declare your disagreement.

4.2. If you disagree with any amendments of which you have been notified, the previous version of the relevant Rules of the Game remains in effect. In this case, however, Battlestate Games Limited has the right to close your Account / terminate your use of the Game and the Licence Agreement by serving 14 (fourteen) calendar days’ notice on you to this effect.
