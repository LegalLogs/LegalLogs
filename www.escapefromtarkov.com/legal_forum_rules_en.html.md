...
The main language used in the Russian section of the Forum is Russian. All messages in any other languages will be removed. This restriction is imposed to ensure the quality of moderation.
...
3.  **Naming Accounts or Characters**
...
*   **_Preliminary moderation (“Pre-moderation”)_**
...
*   **_“Read-Only” status designation_**

“Read-only” status means a restriction that blocks a User’s ability to use the Account, namely to create/send new messages on the Forum, create new topics on the [Forum](https://ru.wikipedia.org/wiki/%D0%92%D0%B5%D0%B1-%D1%84%D0%BE%D1%80%D1%83%D0%BC) and its sections, sending messages to other Users. A User with this status can only read the materials published on the Forum.

*   **_“Blocked” (“Ban”) status designation_**
...
**_7.1. Provocation, trolling, flame_**
...
**_7.2. Usage of profanity, masked profanity, vulgar expressions, inflammatory language_**
...
**_7.3. Derogatory attitude, or offenses based on racial and/or national prejudice_**
...
**_7.4. Off-topic messages, messages flood, spam_**
...
**_7.5. Posting referral links, advertising links, or other types of advertising_**
...
**_7.6. Posting photos/videos and other materials of NSFW/shocking/pornographic nature in messages and profiles_**
...
**_7.9. Prohibition against reviving long inactive topics (necroposting)_**
...
**_7.10. Creating multiple Accounts or Characters_**
...
**_7.11. Distribution of information on cheats_**
...
**_7.13. Ban on discussions of actions taken by the Administration_**
