...
BY DOWNLOADING, UPLOADING, COPYING OR OTHERWISE USING THE GAMES OF BATTLESTATE GAMES LIMITED OR PART THEREOF, YOU HEREBY CONFIRM THAT YOU HAVE READ, UNDERSTOOD, AGREED AND ACCEPTED IN FULL THE LICENCE AGREEMENT BELOW AND UNDERTAKE TO OBSERVE IT AND BEAR LIABILITY FOR ANY VIOLATION THEREOF.

THE TERMS OF THE LICENCE AGREEMENT AND KEY DOCUMENTS (CLAUSE 2.2 BELOW) ARE ESSENTIAL AND BINDING.

This licence agreement (“the Agreement”) establishes the terms on which you (“the User”) are granted a licence to install and use the computer game Escape From Tarkov.

1.  TERMS USED IN THIS AGREEMENT

1.1. Game – multi-player computer game Escape From Tarkov, being a software consisting of a set of data and commands, as well as audio-visual images produced thereby (hereinafter “the data and commands”), activated consecutively to obtain a result corresponding to the game scenario. The software also includes Game resources, supplementary and update elements to the Game (patches), as well as databases. Elements of the Game include but are not limited to the following: object code, individual software, instructions; any names, including names of places, Game points and the like; Game scenarios and individual parts thereof; texts of characters, fonts, audio sequence, visual sequence, interfaces, characters, their appearance and accessories and the like.

1.2. Licensor – BATTLESTATE GAMES LIMITED, legal address Wework Aviation House, 125 Kingsway, London, United Kingdom, WC2B 6NH, (hereinafter “Battlestate Games Limited”), and/or another person that, with the consent of Battlestate Games Limited, grants you the right to use the Game. The Licensor may discharge its obligations hereunder either personally or by engaging third parties.
...
1.4. Account – the User profile created by the User and belonging to Battlestate Games Limited consisting in the aggregate of User data stored on the Game resources for identification (authentication) of the User thereon and provision of access to the User’s personal data, settings and statistics in the Game, as well as to any similar information and functional of the Game.

1.5. Game resources – all servers, software, portals, websites and databases relating to the Game and located, among other things, on the websites http://www.battlestategames.com or other websites of Battlestate Games Limited and/or the Licensor relating to the Game (including all subdomains).

1.6. Game elements – the entire set of objects, items, elements and methods of the gameplay used in the Game.

1.7. Game website – the website located at http://www.battlestategames.com or other websites of Battlestate Games Limited relating to the Game (including all subdomains) providing the User with access to the resources of the Licensor, including for using the Game. The Licensor posts the information required for the User on the Game website.
...
1.11. Forum Rules – an attachment to the Agreement setting User rules of conduct on the official Game forum (“the Forum”) and the User’s liability for breaking the Forum Rules posted on the Game website. The Forum Rules may be amended by the Licensor at any time without notifying the User in advance. The Licensor notifies the User of such amendments by posting information on the Game website. By using the Forum in any way after the Forum Rules are changed, the User consents to such changes.
...
3.1. The Licensor grants the User the right to use the Game in the scope, by the means, for the term and in within the bounds of the Territory specified herein or in the Key Documents and (or) the Internet resources to which the Agreement refers. The User is granted a simple (non-exclusive) licence to the Game, including the Game Client.

3.2. The Licence to the Game, including the Game Client, applies to updates, additions and supplementary components that may be provided or access to which may be provided by the Licensor, as well as by authorised representatives of the Licensor during use by the User of the Game Client, other than when the right to use such updates, additions and supplementary components is granted on the basis of separate agreements. Any updates, additions and supplements to the Game Client are installed in the same system folders and files on the User’s PC in which the version of the Game Client is stored. If any material changes are made to the Game Client, the Licensor undertakes to notify the User additionally by means not conflicting with the Agreement or violating the rights and interests of the User.

3.3. The Licensor operates and services the Game. The User is granted the right to use the Game, including the Game Client, exclusively by Battlestate Games Limited and/or by the Licensor, or their authorised representatives.
...
4.  USER RIGHTS AND BOUNDS OF USE OF THE GAME
...
4.3.1. Independently take steps to ensure the security of their Account and prevent its unsanctioned use by third parties. The User undertakes not to disclose or transfer to third parties their identification details by which the User may be authorised (authenticated).

4.3.2. Fulfil the instructions of Battlestate Games Limited and of the Licensor received individually or as part of a group of users in the Game, the user support centre or the news section of the Game Website, in the Game Forum or by other means. Battlestate Games Limited and the Licensor have the right to suspend, restrict or terminate the User’s right to use the Game if these instructions are not observed.

4.3.3. On the demand of Battlestate Games Limited and/or of the Licensor in connection with conclusion and performance hereof, confirm their personal or other data required for fulfilling the conditions of the Agreement and observing the legislation.
...
*   Prohibited commercial use: use, either in total or individual parts, of the Launcher Application or of the Game for any purposes not expressly permitted by Battlestate Games Limited, including, among other things: (i) use of the Game in commercial establishments; (ii) collection of game money, items, materials, resources, etc. for sale outside the Game; (iii) provision of game services, such as raising the level, in exchange for payment outside the Game; or (iv) transfer or facilitation of distribution (by text or audio means or any other method) of commercial advertising or offers through or within the scope of the Game;
*   “cybersport”: use of the Game(s) for organising cybersports or group competitions, sponsored, promoted or motivated by any commercial or non-commercial organisation, without obtaining an additional licence from Battlestate Games Limited, or without obtaining the prior written consent to this from Battlestate Games Limited;
...
*   unauthorised connection: facilitation of unauthorised connection, installation or support of unauthorised connection to the Game, including, among other things, (i) any connection to an unsanctioned server that emulates or attempts to emulate the operation of the Game; as well as (ii) any connection using outside programs or instruments not specially authorised by Battlestate Games Limited;
*   transfer: attempts to sell any versions of the Game, issue licences or sublicences for them, provide them for temporary use or lease, lending, pledge and other transfer thereof to third parties, unless expressly permitted hereby;
...
4.3.5. Reimburse Battlestate Games Limited, other users of the Game and (or) other third parties for any losses incurred thereby as a result of actions on the part of the User, including in connection with breach of this Agreement, intellectual or other rights of the given persons.

4.3.6. Promptly notify Battlestate Games Limited of any unsanctioned use of the Account, hacking or any other such actions.
...
7.  RESTRICTED LIABILITY OF THE LICENSOR

7.1. The Licensor and/or Battlestate Games Limited, their authorised representatives and the right holders of the protected intellectual products do not bear liability for:

7.1.1. Unlawful or other actions on the part of the User and (or) third parties impeding use of the Game.

7.1.2. Statements made by the User on Game resources. Battlestate Games Limited and/or the Licensor are not liable for the conduct of the User in the Game and on Game resources, including for disrespect towards other users.
...
7.6. Battlestate Games Limited and/or the Licensor are not liable for any direct or indirect damage or lost profit incurred by the User or third parties, even if the User submits a notification of the likelihood of such damage and/or losses occurring as a result of:
...
10.5. The rights to unlimited gratuitous use of Materials constituting intellectual products transfer to Battlestate Games Limited in form of a simple (non-exclusive) licence on the territory of all states in the world from the moment they are posted (published) by the User in the Game, without any counter-obligation to pay any author’s or other remuneration and without limitation in time, method or territory of use. The rights to use the Materials under this clause include the right to use them in any manner and in any country of the world, including publicising, distributing, modifying, adapting, otherwise processing, publishing and creating derivatives without the obligation to name the author or any other counter-obligations. The User undertakes ensure legal grounds also for granting Battlestate Games Limited the intellectual property rights to Materials posted by the User in the Game and belonging to other right holders.

10.6. All use of intellectual products or part thereof posted in the Game is prohibited without prior written permission from Battlestate Games Limited, other than in cases specified herein.

10.7. The trade marks “Escape From Tarkov” and “Battlestate Games” are registered and protected in different jurisdictions in the world. Trade marks of third parties mentioned in the Game or its description belong to their legal right holders.

11.  TERM, AMENDMENT AND CANCELLATION OF THE AGREEMENT
...
11.4. Battlestate Games Limited and/or the Licensor has the right to cancel this Agreement unilaterally and extra-judicially at any time, terminating the right to use the Game and possibility of doing so in the following cases:

11.4.1. Closure of the Game. In this case, Battlestate Games Limited or the Licensor shall, at least one hundred and eighty (180) calendar days prior to closure of the Game, send the User a relevant n notice. Whereat Battlestate Games Limited does not pay any compensation and, among other things, does not reimburse the User for the monetary equivalent of the in-game currency or the like.
...
11.5. The User has the right at any time, without notifying Battlestate Games Limited and/or the Licensor and without explanation, to terminate this Agreement unilaterally and extra-judicially by deleting the Game Client and the Game from the memory of the computer and/or deleting the Account, while retaining the obligations and liability of the User arising prior to deletion of the Account. In this case, all the Game elements linked to this Account will be deleted without the right to restore them. Battlestate Games Limited and/or the Licensor is not required to pay the User any compensation in this event.

11.6. The User confirms that Battlestate Games Limited and/or the Licensor has the unconditional right to change the conditions of the Key Documents unilaterally and that such amendments do not constitute amendments hereto.

12.  FINAL PROVISIONS

12.1. This Agreement supersedes all previous agreements between the Parties.

12.2. If one or several provisions hereof are duly recognised as invalid under a court judgement that has come into legal effect, the other provisions hereof remain in effect and the Parties continue to discharge their obligations in a manner corresponding as far as possible to the intentions of the Parties when they concluded and (or) amended this Agreement.
...
12.4. This Agreement and all disputes, claims and obligations (contractual and non-contractual) arising on the basis of or in connection therewith, their subject or conclusion are regulated by the law of England and Wales. Unless otherwise envisaged by the legislation of the country in which the User resides, the Parties are subject to the jurisdiction of courts of England and Wales.